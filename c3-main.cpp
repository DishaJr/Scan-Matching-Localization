...
//           	PointCloudT::Ptr mapcloud(new PointCloudT);
			...
			PointCloudT::Ptr newscanCloud (new PointCloudT);
          	pcl::transformPointCloud(*cloudFiltered, *newscanCloud, transform);
			viewer->removePointCloud("scan");
          
			// TODO: Change `scanCloud` below to your transformed scan
			renderPointCloud(viewer, newscanCloud, "scan", Color(1,0,0) );
